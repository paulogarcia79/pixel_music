...
- ✅ Todo desarrollo de frontend, componentes y estilos DEBE basarse rigurosamente en las directrices de la skill 'frontend-design' para asegurar un acabado estético de alto nivel, libre de plantillas de IA genéricas.
