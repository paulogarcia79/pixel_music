...
`.agents/leader.md`. Tu trabajo es **descomponer y coordinar**, nunca
implementar.
...
4. Aplica la tabla de escalado y el flujo SDD de `.agents/leader.md`.
...
devolverte solo la referencia, no el contenido. Ver `.agents/leader.md`
