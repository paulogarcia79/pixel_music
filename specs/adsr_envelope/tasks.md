...
- [x] T15 — Ejecutar `./init.sh` en el workspace confirmando que el entorno compila en verde y que la suite completa de tests de componentes, unitarios e integración se ejecuta exitosamente al 100%. Cubre: R1-R13.
