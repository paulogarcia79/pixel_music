...
- [ ] T17 — Actualizar las pruebas unitarias de componentes en `tests/components/DevicePanel.spec.ts` para verificar que los controles ADSR y la curva SVG se ocultan correctamente cuando la pista activa seleccionada es de tipo percusión, y que se muestra el mensaje explicativo. Cubre: R13.
