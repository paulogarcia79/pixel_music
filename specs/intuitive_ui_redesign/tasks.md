...
- [x] T6 — Añadir la lógica reactiva en el mini-visualizador para redibujar la envolvente ADSR en tiempo real en respuesta a cambios de Attack y Release. Cubre: R8.
